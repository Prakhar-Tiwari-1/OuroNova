...
- **Contractors** (Karim, Lyon) pay €120/tonne to dump materials worth €220 — because there's no trusted marketplace to sell salvage.
- **Buyers** (Élodie, Marseille) drive 60 km hoping to find reclaimed oak — because supply is fragmented and unverified.
...
Or open `index.html` directly in a browser (file:// works for this project).
